...
import math
import numpy as np
# Blender提供的数学工具模块，用于处理矩阵、向量、四元数等
...
###############################
#smpl 人体模型
smpl_model = r"E:\project\blender\import_anim_GVHMR_b4.2_v2.blend\SMPL_maya\basicModel_m_lbs_10_207_0_v1.0.2.fbx"
# 动捕数据，一共90秒
file = r'E:\project\blender\import_anim_GVHMR_b4.2_v2.blend\hmr4d_results.pt.pkl'
# 人物模型和地面的高度差
high_from_floor = 1.5
##############################
...
for fframe in range(0,qtd_frames):
    ...
    # 将root和其他joint的旋转数据拼接到一起，获得全身数据
